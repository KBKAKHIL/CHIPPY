...
public class Enemy {
    ...
    private ArrayList<Rect> bullets1 = new ArrayList<Rect>();
    private ArrayList<Rect> bullets2 = new ArrayList<Rect>();
    private ArrayList<Rect> bullet4 = new ArrayList<Rect>();
    ...
    public ArrayList<Rect> getBullets1() {
        return bullets1;
    }
    ...
    public void spawnBullet() {
        ...
        Rect bullet1 = new Rect(this.xPosition - this.image.getWidth()  ,
                this.yPosition + this.image.getHeight(),
                this.xPosition - this.image.getWidth() + BULLET_WIDTH ,
                this.yPosition + this.image.getHeight()  + BULLET_WIDTH
        );
        this.bullets1.add(bullet1);
